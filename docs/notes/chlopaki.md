...
```bash
uvx --from modal==1.5.0 modal run scripts/style_modal.py --stage train --data-run chlopaki-bidirectional-v1 --model qwen3.5-4b --epochs 1 --max-seconds 600 --batch-tokens 2048
```
...
```bash
uvx --from modal==1.5.0 modal run scripts/style_modal.py --stage train --data-run chlopaki-bidirectional-v1 --model qwen3.5-4b --epochs 1 --max-seconds 180 --batch-tokens 2048 --resume-run PREVIOUS_RUN_NAME
```
...
```bash
uvx --from modal==1.5.0 modal run scripts/style_modal.py --stage sample --data-run style-train-wit-1788781334049902996
uvx --from modal==1.5.0 modal run scripts/style_modal.py --stage sample --data-run style-train-wit-1788781334049902996 --adapter-scale 0.25
```
