...
**8 September update:** the user explicitly wants a new scratch-training v2, not a port of Falenty v1. [docs/notes/scratch-v2.md](scratch-v2.md) supersedes the scratch-model/preset recommendations below; the older measurements remain historical evidence.
