...
```bash
uvx --from modal==1.5.0 modal run scripts/corpus_modal.py --max-seconds 600
```
...
```bash
uvx --from modal==1.5.0 modal run scripts/corpus_probe_modal.py
```
...
```bash
uvx --from modal==1.5.0 modal run scripts/corpus_modal.py --target-tokens 2048 --batch-size 1 --line-aligned --max-seconds 600
```
...
```bash
uvx --from modal==1.5.0 modal run scripts/corpus_probe_modal.py --adapter-run pan-tadeusz-1788794554392255032 --long-output-tokens 1024
```
