...
- `local/`: large downloads and prepared pretraining corpora; gitignored. Used by the optional local preparation script. The main exercise prepares data directly in a Modal volume.
