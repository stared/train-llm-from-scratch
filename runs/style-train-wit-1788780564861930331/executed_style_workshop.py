...
def train(data_dir, output, model_key='qwen3.5-4b', epochs=4, max_seconds=300, device='cuda', lr=1e-4, batch_tokens=0):
    import torch
    ...
    history = []; seen = set(); examples_seen = 0
...
if __name__ == '__main__':
    ...
    if a.stage=='data':
        ...
        train(a.data_dir,a.output,a.model,a.epochs,a.max_seconds,a.device,batch_tokens=a.batch_tokens)
    else:
