...
def run(data_dir, output, size='10m', max_seconds=300, seed=42, device='cuda', batch_size=32, context_length=256, eval_interval=60, peak_lr=6e-4, warmup_steps=20, checkpoint_hook=None):
    if not 60<=max_seconds<=4200 or batch_size not in (8,16,32,64):
        raise ValueError('Use60–4200seconds and batch8/16/32/64')
...
if __name__=='__main__':
    ...
    p.add_argument('--size',choices=['10m','30m','100m'],default='10m')
