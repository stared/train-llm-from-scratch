...
if __name__ == '__main__':
    ...
    parser.add_argument('--full', type=Path, default=ROOT/'data/wiki-scratch-v1')
    parser.add_argument('--leads', type=Path, default=ROOT/'data/wiki-leads-v1')
    parser.add_argument('--output', type=Path, default=ROOT/'data/wiki-popular-v1')
