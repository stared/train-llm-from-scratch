...
probe_image=(modal.Image.debian_slim(python_version='3.12')
    ...
    .add_local_file('scripts/dialogue_probe.py','/work/scripts/dialogue_probe.py'))
...
def experiment(adapter_run):
    ...
    try:
        ...
        (path/'executed_dialogue_probe.py').write_text(Path('/work/scripts/dialogue_probe.py').read_text())
