...
probe_image=(modal.Image.debian_slim(python_version='3.12')
    ...
    .add_local_file('scripts/corpus_probe.py','/work/scripts/corpus_probe.py'))
...
def experiment(adapter_run,long_output_tokens):
    ...
    try:
        ...
        (path/'executed_corpus_probe.py').write_text(Path('/work/scripts/corpus_probe.py').read_text())
