...
The comic adapter's sampled probe cost $0.0305 and had similar limitations. [Open the complete offline comparison](SHOWCASE.html): 32 prompt cards, 96 real answers, and a Polish/English filter. The Gemma attempt has a [separate rejected-run comparison](REJECTED_GEMMA.html).
