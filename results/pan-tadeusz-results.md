...
The fresh 2,048-target line-aligned adapter has now been trained and tested, including two 1,024-output-token diagnostics. [Full comparison with this original 256-target adapter](pan-tadeusz-2048-results.md).
