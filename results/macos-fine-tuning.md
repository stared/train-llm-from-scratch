...
Tested on 22 September 2026: **MacBook Pro, M5 Max, 128 GB unified memory**. Model: **Qwen3.5-0.8B**, using the same pinned model revision and driving-question data as the workshop.
