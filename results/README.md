...
Earlier results remain here for comparison, including unsuccessful experiments. Raw predictions, metrics and source snapshots remain under [`runs/`](../runs/). See the [`LAB_NOTEBOOK.md`](../LAB_NOTEBOOK.md) for experiment history.
