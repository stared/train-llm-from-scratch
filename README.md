...
**30M parameters, up to 10 minutes, about $0.78 measured worker compute.** In another terminal, open the live loss chart; after training, the same view shows random and trained text:
