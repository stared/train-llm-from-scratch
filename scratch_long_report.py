...
def render(paths, output_dir=ROOT):
    ...
    (out / 'pretraining_results.html').write_text(HTML.replace('const allRuns=PAYLOAD;', 'const allRuns=' + payload + ';'), encoding='utf-8')
    ...
    (out / 'pretraining_example_results.md').write_text('\n'.join(md), encoding='utf-8')
    return runs
...
if __name__ == '__main__':
    ...
    print(f'Wrote pretraining_results.html and pretraining_example_results.md in {args.output_dir}')
