...
See [docs/pretraining.md](../docs/pretraining.md) for preparation and training commands. Small curated workshop datasets remain in `datasets/`; experiment outputs remain in `runs/`. Only internal tool caches use `.cache/`.
