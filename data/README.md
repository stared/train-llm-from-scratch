...
See [WIKI_SCRATCH.md](../WIKI_SCRATCH.md) for preparation and training commands. Small curated workshop datasets remain in `datasets/`; experiment outputs remain in `runs/`. Only internal tool caches use `.cache/`.
