# Optional pretraining experiments

These comparisons are extra reading after the [Wolne Lektury tutorial](../02-pretraining.md). You do not need to run them to finish the workshop. Every training command starts another billed job.

The figures below are historical measurements, not guaranteed runtimes, prices or results. Differences in settings matter when comparing runs.
...
[Back to the tutorial](../02-pretraining.md).
