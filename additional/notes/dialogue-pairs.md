...
```bash
modal run scripts/style_modal.py --stage train --data-run my-dialogues --model qwen3.5-4b --epochs 4 --max-seconds 300
```
...
**Later supplied-file experiment:** `scripts/prepare_chlopaki.py` handles the headings, abbreviated speakers and unlabelled continuation lines in the user's `datasets/chlopaki.md`. See [additional/notes/chlopaki.md](chlopaki.md) for the actual 1,270-example dataset and training recipe.
