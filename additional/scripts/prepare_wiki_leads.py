...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=Path, default=ROOT / 'datasets/local/wiki-scratch-v1')
    parser.add_argument('--output', type=Path, default=ROOT / 'datasets/local/wiki-leads-v1')
