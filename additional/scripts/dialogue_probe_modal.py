...
probe_image=(modal.Image.debian_slim(python_version='3.14')
    ...
    .add_local_file('additional/scripts/dialogue_probe.py','/work/additional/scripts/dialogue_probe.py'))
...
def experiment(adapter_run):
    ...
    try:
        ...
        (path/'executed_dialogue_probe.py').write_text(Path('/work/additional/scripts/dialogue_probe.py').read_text())
