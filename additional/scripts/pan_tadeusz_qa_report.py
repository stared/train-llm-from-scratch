"""Render actual before/after generations. Run: uv run --no-project additional/scripts/pan_tadeusz_qa_report.py RUN [--sample-run RUN]."""
import sys
...
def main():
    ...
    Path('results/pan-tadeusz-qa-results.md').write_text(report)
