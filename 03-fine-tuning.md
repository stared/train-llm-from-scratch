...
On an M5 Max, this took **95 seconds of training** and improved the test score from **19/40 to 28/40**. Results appear under **SFT** when the run finishes. [Mac experiment results](results/macos-fine-tuning.md).
